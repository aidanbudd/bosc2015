...
*  **Excellent software and related infrastructure** (from SSI’s ["Software Evaluation: Criteria-based Assessment"](http://software.ac.uk/sites/default/files/SSI-SoftwareEvaluationCriteria.pdf))
    * Usability
        * Understandability
        * Documentation
        * Buildability
